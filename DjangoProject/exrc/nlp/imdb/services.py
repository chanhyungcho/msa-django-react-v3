...
from exrc.nlp.imdb.models import ImdbModel
...
class NaverMovieService(object):
    def __init__(self):
        ...
        # driver_path = r'C:\Users\AIA\MsaProject\DjangoProject\exrc\webcrawler\chromedriver.exe'
        # file_name = r'C:\Users\AIA\MsaProject\DjangoProject\exrc\nlp\imdb\data\naver_movie_review_corpus.csv'
        # review_train = r'C:\Users\AIA\MsaProject\DjangoProject\exrc\nlp\imdb\data\review_train.csv'
        # driver = os.path.join(os.getcwd(),'exrc', 'webcrawler' 'chromedriver.exe')
        # file_name = os.path.join(os.getcwd(),'exrc', 'nlp', 'imdb', 'data', 'naver_movie_review_corpus.csv')
        # review_train = os.path.join(os.getcwd(), 'exrc', 'nlp', 'imdb', 'data', 'review_train.csv')
    ...
    def classify(self, doc):
        result = [{'review': f'{i}', 'result': f'{"%0.f%%"%int(j*100)}'}
                  for i in [doc]
                  for j in [self.probability(word_probs=self.word_probs, doc=doc)]]
        print(result)
        return result
